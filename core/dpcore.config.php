 ...
 *
 * 	@copyright Devahil Leivzieük, devahil@gmail.com 2010 - 2015
...
class coreconfig {
    ...
    public $applibs = "applibs";//A special variable where you put the personal app libs
    public $author = "";
    ...
    public $path_algorithms = "/usr/lib64/libmcrypt";//please check that path for libmcrypt
    public $path_modes = "/usr/lib64/libmcrypt";//please check that path for libmcrypt
