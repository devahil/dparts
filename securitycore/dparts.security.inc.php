...
require ("dparts.security.conf.inc.php");
...
die ("<span class=subred>Error cod.:1 - Acceso incorrecto!<BR><BR>No se puede accesar de esa manera a este Sistema!.");
exit;
}
...
$usuario_consulta = @mysql_query("SELECT ID,usuario,pass,nivel_acceso FROM $table_users WHERE usuario='".$_POST['user']."'") or die(header ("Location:  $redir?error_login=1"));
